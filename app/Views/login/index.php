...
<!-- =========================================================
* GoShop - Bootstrap 5 HTML Admin Template - Pro | v1.0.0
==============================================================

* Product Page: https://themeselection.com/products/GoShop-bootstrap-html-admin-template/
...
>
  ...
  <body style="background-image: url('<?php echo base_url();?>/public/assets/img/backgrounds/bg.png'); background-repeat: no-repeat; background-size: cover;">
    <!-- Content -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">GoShop</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to GoShop! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>
              <!-- <div style="text-align: center; background-color: red; padding: 10px; border: 1px solid orange; border-radius: 5px; margin: 0 auto; width: 50%; height: 15px"> -->
                    <!-- <h3 style="color: white; font-size: 10px;"> -->
                    <?php if ($pesan != NULL) { ?>
...
<?php } ?>
              ...
              <form id="formAuthentication" class="mb-3" action="<?php echo base_url();?>public/Login/cek" method="POST">
                <div class="mb-3">
              ...
              <p class="text-center">
                ...
                <a href="http://localhost/ecatalog/public/register">
